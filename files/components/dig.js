        ...
        productModal.innerHTML = `
            ...
            <div id="CryptoButtons">
                <a id="CryptoButtons" class="blockoPayBtn" data-toggle="modal" data-uid=${dataUid}>
                    <img src="files/imgs/svgs/bitcoin.svg" alt="bitcoin purchase button">
                </a>
                <a id="CryptoButtons">
                    <img src="files/imgs/svgs/ethereum.svg" alt="ethereum purchase button">
                </a>
                <a id="CryptoButtons">
                    <img onclick="share()" src="files/imgs/svgs/share.png" alt="share button">
                </a>
            </div>
            <img id="cruz" src="files/imgs/svgs/x.svg">`;
